 ...
 */
public class BotAgent2 extends Agent {
	// Constants
	// ////////////////////////////////
	...
	protected void setup() {
		try {
			...
			hello.setContent(BotAgent1.HELLO);
			...
			addBehaviour(new CyclicBehaviour(this) {
				public void action() {
					...
					if (msg != null) {
						if (BotAgent1.GOODBYE.equals(msg.getContent())) {
							// time to go
							leaveParty();
						...
						} else if (msg.getContent().startsWith(BotAgent1.HELLO)) {
							// someone saying hello
							passRumour(msg.getSender());
						} else if (msg.getContent()
								.startsWith(BotAgent1.RUMOUR)) {
	...
	protected void introducing(String agentName) {
		...
		m1.setContent(BotAgent1.INTRODUCE);
