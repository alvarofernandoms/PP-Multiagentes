...
public class BotUIFrame extends JFrame {
	...
	protected BotAgent1 m_owner;

	// Constructors
	// ////////////////////////////////

	public BotUIFrame(BotAgent1 owner) {
		try {
			jbInit();
		} catch (Exception e) {
			e.printStackTrace();
	...
	private void jbInit() throws Exception {
		...
		lbl_numGuests.setText("Número de bots:");
	...
	void btn_start_actionPerformed(ActionEvent e) {
		...
		m_owner.addBehaviour(new OneShotBehaviour() {
			public void action() {
				((BotAgent1) myAgent).inviteGuests(slide_numGuests.getValue());
			}
		});
	}
	...
	void btn_Exit_actionPerformed(ActionEvent e) {
		m_owner.addBehaviour(new OneShotBehaviour() {
			public void action() {
				((BotAgent1) myAgent).terminateHost();
			}
		});
	}
